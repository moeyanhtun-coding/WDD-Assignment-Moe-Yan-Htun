...
for (let i = 0; i < socialMidiaProfile.length; i++) {
  list2 += `<div class= "profile shadow py-2 px-3 mt-3 w-100" >
              <div
              ...
              >
                <div class="d-flex align-items-center">
                  ...
                  />
                  <div class="userName">
                    <div class="text-dark"><b>${socialMidiaProfile[i]}</b><i class="text-primary ms-2 fa-solid fa-user-check"></i>
</div>
...
let reaction = 10;
const reactionCount = document.querySelector("#_reactionCount");
...
let share = 14;
const shareCount = document.querySelector("#_shareCount");
...
for (let i = 0; i < nameList.length; i++) {
  list += `<div class="messageChatProfile mb-3" >
                ...
                <div class="messageChat">
                  ...
                  <div class="text-primary fw-bold ">${usernameList[i]}</div>
                </div>
              </div> `;
}
